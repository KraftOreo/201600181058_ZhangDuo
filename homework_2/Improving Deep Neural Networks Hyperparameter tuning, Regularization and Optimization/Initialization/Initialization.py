...
# You will use a 3-layer neural network (already implemented for you).
...
# 
# **Instructions**: Please quickly read over the code below, and run it.
...
# this is because of numerical roundoff;
# a more numerically sophisticated implementation would fix this.
# But this isn't worth worrying about for our purposes.
# 
# Anyway, it looks like you have broken symmetry,
# and this gives better results. than before.
...
def initialize_parameters_he(layers_dims):
    ...
    for l in range(1, L + 1):
        ### START CODE HERE ### (≈ 2 lines of code)
        parameters['W' + str(l)] = np.sqrt(2 / layers_dims[l - 1]) * np.random.randn(
